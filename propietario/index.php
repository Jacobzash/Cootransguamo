...
<div class="container-fluid">
    ...
    <?php include("cabecera_propietario.php");?>
...
<div class="row">
        ...
        <br /><br /><br />
          <table width="100%">
            <tr>   
              <td align="center">
                <iframe name="principal"  width="100%" height="570px" allowtransparency=”true” frameborder="0" src="vigencia_licencia.php"></iframe>
              </td>
            </tr>
          </table>
