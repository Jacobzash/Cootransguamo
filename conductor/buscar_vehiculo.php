    ...
    <center>
      <form action="" method="post">
        ...
        <table style="width: 40%"  class="table table-condensed table-hover">
          <tr>
            <td colspan="2" align="center" style="background-color: #f0b650; color: #fff"><h3>Buscar Vehiculo Asignado al Conductor</h3></td>
          </tr>
          <tr>
            <td style="width: 20%">
              Placa del Vehiculo
            </td>
            <td style="width: 20%"><input class="form-control" type="text" name="placa_vehiculo" style="width:300px; height:27px" required /></td>
          </tr>
          <tr>
...
else
{
          ...
          if(isset($_POST['placa_vehiculo']) && !empty($_POST['placa_vehiculo']))
          {
            ...
            $sql = "SELECT * FROM vehiculos,estado,tipo_vehiculo,asignar WHERE vehiculos.id_estado=estado.id_estado 
  ...
  <?php
           ...
           else
           {
             ...
             echo "<h2>El Vehículo no está asignado al Conductor</h2>";
