...
<nav class="navbar navbar-default navbar-fixed-top">
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="acolapsar">
              ...
              <ul class="nav navbar-nav">
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Taquillero <span class="caret"></span></a>
                  <ul class="dropdown-menu">
                    <li><a href="datos_taquillero.php" target="principal">Actualizar Datos </a></li>
                  </ul>
                </li>
              </ul>
              <ul class="nav navbar-nav">
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Vehículos <span class="caret"></span></a>
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="listar_vehiculo.php" target="principal">Listar Vehiculos </a></li>
                  </ul>
                </li>
              </ul>
              <ul class="nav navbar-nav">
