          ...
          <tr>
            <td style="width: 20%">
              <select name="lista" style="width:300px; height:27px" required >
                <option value="documento_taquillero">Documento</option>
                <option value="nombres_taquillero">Nombres</option>
                <option value="apellidos_taquillero">Apellidos</option>
              </select>
            </td>
...
else
{
             ...
             isset($_POST['buscar']) && !empty($_POST['buscar']))
          {
            ...
            $sql = "SELECT * FROM taquilleros,estado WHERE taquilleros.id_estado=estado.id_estado 
  ...
  ?>
                ...
                <tr>
                <td><?php echo $reg['documento_taquillero']; ?></td>
                <td><?php echo $reg['nombres_taquillero']; ?></td>
                <td><?php echo $reg['apellidos_taquillero']; ?></td>
                <td><?php echo $reg['direccion_taquillero']; ?></td>
                <td><?php echo $reg['celular_taquillero']; ?></td>
  ...
  <?php
           ...
           else
           {
             ...
             echo "<h2>El Taquillero no se encuentra </h2>";
             echo "<meta http-equiv='Refresh' content='3;url=buscar_taquillero.php'>";
             echo "</center>";
           }
