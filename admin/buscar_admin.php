 ...
 ?>  
    ...
    <center>
      <form action="" method="post">
        <h2>Busqueda de Administrador</h2>
          ...
          <tr>
            <td style="width: 20%">
              <select name="lista" style="width:300px; height:27px" required >
                <option value="documento_usuario">Documento</option>
                <option value="nombres_usuario">Nombres</option>
                <option value="apellidos_usuario">Apellidos</option>
              </select>
            </td>
...
else
{
             ...
             isset($_POST['buscar']) && !empty($_POST['buscar']))
          {
            ...
            $sql = "SELECT * FROM Usuarios,estado WHERE Usuarios.id_estado=estado.id_estado 
  ...
  ?>
                ...
                <tr>
                <td><?php echo $reg['documento_usuario']; ?></td>
                <td><?php echo $reg['nombres_usuario']; ?></td>
                <td><?php echo $reg['apellidos_usuario']; ?></td>
                <td><?php echo $reg['direccion_usuario']; ?></td>
                <td><?php echo $reg['celular_usuario']; ?></td>
  ...
  <?php
           ...
           else
           {
             ...
             echo "<h2>El Administrador no se encuentra </h2>";
             echo "<meta http-equiv='Refresh' content='3;url=buscar_admin.php'>";
             echo "</center>";
           }
